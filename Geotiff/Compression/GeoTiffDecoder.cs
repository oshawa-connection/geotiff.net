...
public abstract class GeoTiffDecoder
{
    ...
    public async Task<ArrayBuffer> Decode(ArrayBuffer buffer, GeoTiffImage image, int tileWidth, int tileHeight, int predictor, int[] bitsPerSample, int planarConfiguration)
    {
