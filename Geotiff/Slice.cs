...
/// <summary>
/// In geotiff.js This is an implicit type (i.e. an object, not declared as class)
/// that gets passed as an argument to some functions
/// and as a return type.
/// It is NOT the same as DataSlice
/// </summary>
public class Slice
{
